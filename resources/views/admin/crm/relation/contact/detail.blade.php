...
<div class="kt-portlet__body kt-portlet__body--fit-inline-datatable">
    ...
    <div class="row">
        <div class="col-xl-5 col-lg-7">
            ...
            {{ KJField::date('BIRTHDAY_DATE', KJLocalization::translate('Admin - Taken', 'Geboortedatum', 'Geboortedatum'), ($item ? $item->getBirthdayDateFormattedAttribute() : ''), ['data-locale-format' => \KJ\Localization\libraries\LanguageUtils::getJSDatePickerFormat()]) }}

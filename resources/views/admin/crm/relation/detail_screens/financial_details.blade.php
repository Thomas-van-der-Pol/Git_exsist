<div class="kt-portlet__body">
    ...
    {{ Form::hidden('ID', $item ? $item->ID : -1) }}
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6">
                {{ KJField::select('FK_FINANCE_PAYMENT_TERM', KJLocalization::translate('Admin - CRM', 'Betalingsconditie', 'Betalingsconditie'), $paymentTerms, $item ? $item->FK_FINANCE_PAYMENT_TERM : '', true, 0, ['data-screen-mode' => 'read, edit']) }}

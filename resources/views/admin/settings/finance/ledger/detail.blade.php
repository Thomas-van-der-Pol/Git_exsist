...
<div class="kt-portlet__body kt-portlet__body--fit-inline-datatable">
    ...
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            ...
            {{-- Required --}} {{ KJField::number('ACCOUNT',KJLocalization::translate('Admin - Financieel', 'Grootboeknummer', 'Grootboeknummer'), $item ? $item->ACCOUNT : 0, true, ['required', 'min' => 1, 'steps' => 1]) }}
        </div>
    </div>

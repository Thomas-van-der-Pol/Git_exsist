                ...
                <div class="kt-widget kt-widget--user-profile-1 pb-0">
                    <div class="kt-widget__body">
                        <div class="kt-widget__items nav" role="tablist">
                            <a href="#contacts" data-id="{{ $item->ID }}" class="kt-widget__item kt-widget__item--active" data-toggle="tab" role="tab" aria-selected="true">
                            ...
                            <a href="#addresses" data-id="{{ $item->ID }}" class="kt-widget__item" data-toggle="tab" role="tab" aria-selected="false">
                                <span class="kt-widget__section">
                                    <span class="kt-widget__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
{{--                            </a>--}}
                            ...
                            <a href="#financial_details" data-id="{{ $item->ID }}" class="kt-widget__item" data-toggle="tab" role="tab" aria-selected="false">
                                <span class="kt-widget__section">
                                    <span class="kt-widget__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
{{--                            </a>--}}
                            ...
                            <a href="#invoices" data-id="{{ $item->ID }}" class="kt-widget__item" data-toggle="tab" role="tab" aria-selected="false">
                                <span class="kt-widget__section">
                                    <span class="kt-widget__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <a href="#tasks" data-id="{{ $item->ID }}" class="kt-widget__item" data-toggle="tab" role="tab" aria-selected="false">
                                <span class="kt-widget__section">
                                    <span class="kt-widget__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="kt-portlet kt-portlet--mobile kt-portlet--height-fluid" id="detailScreenContainer">
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="tab-content">
                            <div class="tab-pane active" id="contacts" data-id="{{ $item->ID }}" role="tabpanel"></div>
                            <div class="tab-pane" id="addresses" data-id="{{ $item->ID }}" role="tabpanel"></div>
{{--                            <div class="tab-pane" id="projects" data-id="{{ $item->ID }}" role="tabpanel"></div>--}}
                            <div class="tab-pane" id="financial_details" data-id="{{ $item->ID }}" role="tabpanel"></div>
{{--                            <div class="tab-pane" id="documents" data-id="{{ $item->ID }}" role="tabpanel"></div>--}}
                            <div class="tab-pane" id="invoices" data-id="{{ $item->ID }}" role="tabpanel"></div>
                            <div class="tab-pane" id="tasks" data-id="{{ $item->ID }}" data-type="{{ config('task_type.TYPE_RELATION') }}" role="tabpanel"></div>
                        </div>
                    </div>
                </div>
            </div>

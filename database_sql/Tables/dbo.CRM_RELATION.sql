...
GO
ALTER TABLE [dbo].[CRM_RELATION] ADD CONSTRAINT [FK_CRM_RELATION_FINANCE_PAYMENT_TERM] FOREIGN KEY ([FK_FINANCE_PAYMENT_TERM]) REFERENCES [dbo].[FINANCE_PAYMENT_TERM] ([ID])
GO

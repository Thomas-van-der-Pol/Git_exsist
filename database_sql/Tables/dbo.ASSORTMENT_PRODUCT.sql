...
[FK_ASSORTMENT_PRODUCT_TYPE] [int] NOT NULL,
...
GO
ALTER TABLE [dbo].[ASSORTMENT_PRODUCT] ADD CONSTRAINT [FK_ASSORTMENT_PRODUCT_ASSORTMENT_PRODUCT_TYPE] FOREIGN KEY ([FK_ASSORTMENT_PRODUCT_TYPE]) REFERENCES [dbo].[ASSORTMENT_PRODUCT_TYPE] ([ID])
GO

...
GO
ALTER TABLE [dbo].[FINANCE_INVOICE_LINE] ADD CONSTRAINT [FK_FINANCE_INVOICE_LINE_PROJECT_ASSORTMENT_PRODUCT] FOREIGN KEY ([FK_PROJECT_ASSORTMENT_PRODUCT]) REFERENCES [dbo].[PROJECT_ASSORTMENT_PRODUCT] ([ID])
GO

    ...
    <div class="kt-login__body">
        ...
        <div class="kt-login__form kj-loginwrapper">
            <div class="kt-login__title">
                <h3>{{ KJLocalization::translate('Login', 'Login', 'Login') }}</h3>
            </div>
            ...
            <form class="kt-form form-login" novalidate="novalidate" action="@yield('submitRoute')" method="POST">
                ...
                <div class="form-group">
                    <input id="EMAILADDRESS" type="email" placeholder="{{ KJLocalization::translate('Login', 'Email address', 'Email address') }}" class="form-control m-input" name="EMAILADDRESS" value="{{ old('EMAILADDRESS') }}" autocomplete="off" required autofocus>
                </div>
                <div class="form-group">
                    <input id="password" type="password" placeholder="{{ KJLocalization::translate('Login', 'Password', 'Password') }}" class="form-control m-input m-login__form-input--last" name="password" required>
                </div>

                <!--begin::Action-->
                <div class="kt-login__actions">
                    <a href="javascript:;" id="kt_login_forgot" class="kt-link kt-login__link">{{ KJLocalization::translate('Login', 'Forget Password', 'Forget Password') }} ?</a>
                    <button id="kt_login_signin_submit" class="btn btn-primary btn-elevate kt-login__btn-primary">
                        {{ KJLocalization::translate('Login', 'Login', 'Login') }}
                    </button>
                </div>
            ...
            <div class="kt-login__options">
                @foreach(config('language.langs') as $lang)
                    ...
                    <a href="/changeLanguage/{{ $lang['CODE'] }}" class="btn kt-btn">
        ...
        <div class="kt-login__form kj-passwordforgetwrapper">
            <div class="kt-login__title">
                <h3>{{ KJLocalization::translate('Login', 'Forget password', 'Forget password') }}</h3>
            </div>

            <!--begin::Form-->
            <form class="kt-form form-forget" novalidate="novalidate" action="{{ route('password.request') }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <input type="email" placeholder="{{ KJLocalization::translate('Login', 'Email address', 'Email address') }}" class="form-control m-input" name="EMAILADDRESS" value="{{ old('EMAILADDRESS_FORGET') }}" autocomplete="off" required autofocus>
                </div>

                <!--begin::Action-->
                <div class="kt-login__actions">
                    <button id="kt_login_forgot_submit" class="btn btn-primary btn-elevate kt-login__btn-primary">
                        {{ KJLocalization::translate('Login', 'Request', 'Request') }}
                    </button>
                    <button id="kt_login_forgot_cancel" class="btn btn-pill kt-login__btn-secondary">
                        {{ KJLocalization::translate('Login', 'Cancel', 'Cancel') }}
                    </button>
                </div>

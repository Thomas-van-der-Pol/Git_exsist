...
GO
ALTER TABLE [dbo].[FINANCE_BILLCHECK] ADD CONSTRAINT [FK_FINANCE_BILLCHECK_PROJECT_ASSORTMENT_PRODUCT] FOREIGN KEY ([FK_PROJECT_ASSORTMENT_PRODUCT]) REFERENCES [dbo].[PROJECT_ASSORTMENT_PRODUCT] ([ID])
GO

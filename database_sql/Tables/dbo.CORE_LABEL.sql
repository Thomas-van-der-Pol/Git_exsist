...
[FK_FINANCE_LEDGER_DEFAULT_PROJECT] [int] NULL,
[FK_FINANCE_VAT_DEFAULT_PROJECT] [int] NULL,
...
GO
ALTER TABLE [dbo].[CORE_LABEL] ADD CONSTRAINT [FK_CORE_LABEL_FINANCE_LEDGER] FOREIGN KEY ([FK_FINANCE_LEDGER_DEFAULT_PROJECT]) REFERENCES [dbo].[FINANCE_LEDGER] ([ID])
GO
ALTER TABLE [dbo].[CORE_LABEL] ADD CONSTRAINT [FK_CORE_LABEL_FINANCE_VAT] FOREIGN KEY ([FK_FINANCE_VAT_DEFAULT_PROJECT]) REFERENCES [dbo].[FINANCE_VAT] ([ID])
GO
